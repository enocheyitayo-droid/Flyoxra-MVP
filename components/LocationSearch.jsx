    ...
    <div ref={wrapRef} style={{ position: 'relative' }} id={id}>
      ...
      {open && results.length > 0 && (
        <div style={{
          ...
          background: '#0C101C', border: '1px solid rgba(255,255,255,0.12)',
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        background: globalIdx === active ? 'rgba(191, 155, 84, 0.28)' : 'transparent',
                        borderBottom: ii < items.length - 1 ? '1px solid rgba(255,255,255,0.12)' : 'none',
